...
def add_user_location_interaction_into_graph(positive_rating,Graph):
	'''
	...
	user_node = positive_rating[0]
	location_node = positive_rating[1]
	Graph.add_node(user_node)
	Graph.add_node(location_node)
	Graph.add_edge(user_node, location_node)
...
def mine_paths_between_nodes(Graph, user_node, location_node, maxLen, sample_size):
	'''
...
def dump_paths(Graph, rating_pair, maxLen, sample_size):
	...
	# 	user_node = 'u' + user_id
	# 	location_node = 'i' + location_id
	user_node = rating_pair[0]
	location_node = rating_pair[1]
	if Graph.has_node(user_node) and Graph.has_node(location_node):
		return mine_paths_between_nodes(Graph, user_node, location_node, maxLen, sample_size)
